...
\begin{enumerate}[leftmargin=*]
  \item \textbf{Gradient Boosting is the clear winner}, beating Random
        Forest by 4.6\,mg\,g$^{-1}$ on CV RMSE and 8.7 on 10-trial RMSE.
        The margin is small in absolute terms but consistent across both
...
\midrule
521  & 37 & 10 & 0.529 & 551.3 & 0.20 \\
737  & 37 & 10 & 0.792 & 308.6 & 0.30 \\
740  & 37 & 10 & 0.227 & 444.3 & 0.10 \\
660  & 37 & 10 & 0.845 & 185.7 & 0.10 \\
411  & 37 & 10 & 0.048 & 240.6 & 0.10 \\
678  & 37 & 10 & 0.891 & 150.9 & 0.10 \\
626  & 37 & 10 & 0.713 & 314.8 & 0.10 \\
513  & 37 & 10 & $-0.208$ & 200.5 & 0.00 \\
859  & 37 & 10 & 0.026 & 290.9 & 0.10 \\
136  & 37 & 10 & 0.698 & 422.3 & 0.20 \\
\midrule
\textbf{Mean} & & & \textbf{0.456} & \textbf{311.0} & \\
\textbf{Std}  & & & \textbf{0.379} & \textbf{127.7} & \\
\textbf{CV}   & & & 0.831         & 0.411          & \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{Gradient Boosting feature importances (impurity-based, full pool,
  HPO-selected model from Section~\ref{sec:hpo}).}
\label{tab:importance}
\begin{tabular}{lr}
\toprule
Feature & Importance \\
\midrule
Specific surface area (SSA) & 0.2988 \\
Pore size (PS)              & 0.2474 \\
Molar dye/AC concentration & 0.2463 \\
Pore volume (PV)            & 0.0978 \\
pH                          & 0.0541 \\
Equilibrium time            & 0.0437 \\
Temperature                 & 0.0120 \\
\bottomrule
\end{tabular}
\end{table}

The top three features (SSA, PS, concentration) account for 79\,\% of
split importance.  Compared with the original exploratory analysis,
SSA has increased in importance (0.30 vs.\ 0.20) due to the HPO-selected
model's use of row subsampling.
However, Spearman rank correlation reveals that
...
Variance of estimate & High (CV$_\text{RMSE}=0.41$); averages 10 noisy estimates & Single point estimate; near-unbiased but high estimator variance due to correlated folds \\
...
limitation.  LOO-CV yields a single RMSE estimate (368.0\,mg\,g$^{-1}$)
...
The 10-trial protocol ($\text{RMSE} = 311.0 \pm 127.7$) benefits from
...
Its 95\,\% bootstrap CI of $\pm$24\,\% of the mean means that small
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Performance saturation is data-limited, not
        ...
        5-fold CV confirmed Gradient Boosting as the best architecture.
        The HPO-selected model achieves a mean test RMSE of
        $311.0 \pm 127.7$\,mg\,g$^{-1}$ on the 10-trial protocol.
...
LOO-CV RMSE (original space) & 368.0 & Near-unbiased, single estimate \\
LOO-CV R$^2$ (original space) & 0.514 & Consistent with 10-trial mean \\
